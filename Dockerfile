...
RUN apt update; apt upgrade -y; apt install wget unzip -y; \
    wget https://github.com/w3c/epubcheck/releases/download/v5.3.0/epubcheck-5.3.0.zip; unzip epubcheck-5.3.0.zip; rm epubcheck-5.3.0.zip; mv epubcheck-5.3.0 /app/target; \
